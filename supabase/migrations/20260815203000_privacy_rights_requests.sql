-- Operational UK GDPR rights workflow. Requests are tracked separately from
-- account deletion so legal retention, identity verification and tenancy records
-- can be reviewed before any irreversible action.
