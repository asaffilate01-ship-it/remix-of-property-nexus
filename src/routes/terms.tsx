...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: [
      { title: "Terms of Service — Estately" },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-16 max-w-3xl prose prose-slate dark:prose-invert">
        ...
        <h2>1. Acceptance</h2>
        <p>By accessing or using Estately ("the Service"), you agree to be bound by these Terms. If you do not agree, do not use the Service.</p>

        <h2>2. The Service</h2>
        <p>Estately provides software-as-a-service tools for estate and letting agencies, landlords, tenants and prospective property buyers/renters, including a marketplace of listings, CRM, HMO management, compliance tracking, work-order management and related features.</p>
        ...
        <p>Agencies are responsible for the accuracy of listings and tenant/landlord data they upload. Estately is a platform and does not act as estate agent or principal in any property transaction unless expressly stated.</p>

        <h2>7. Liability</h2>
        <p>To the maximum extent permitted by law, Estately is not liable for indirect or consequential loss. Our aggregate liability is capped at the fees you paid in the 12 months preceding the claim.</p>
        ...
        <h2>10. Contact</h2>
        <p>Questions? Email <a href="mailto:legal@estately.app">legal@estately.app</a>.</p>
      </main>
      <PublicFooter />
    </div>
  );
